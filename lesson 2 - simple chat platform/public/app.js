document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatIsOppend = document.getElementById('chat-isoppend');
    const chatNotOppend = document.getElementById('chat-notoppend');
    ...
    function connectWebSocket() {
        ...
        socket.onmessage = (event) => {
            ...
            switch (message.type) {
                case 'connected':
                    console.log('Server acknowledged connection. User ID:', message.payload.id);
                    currentUserData = message.payload;
                    document.getElementById('main-user-name').textContent = message.payload.username || 'کاربر';
                    break;
    ...
    function openChatWith(user) {
        chatIsOppend.style.display = "block";
        chatNotOppend.style.display = "none";
    ...
    function updateChatHeader(user) {
        ...
        recipientStatus.textContent = user.status || 'در دسترس'; 
    }
